...
import kiran from './images/kiran-image.png';
		...
		<React.Fragment>
			...
			<div className="App container mt-3">
				<header className="row">
					<h1 className=" col-12 text-center text-white">saikiran</h1>
					<h4 className=" col-12 text-center text-white">Full Stack Developer</h4>
				</header>
				<div className="row parent">
					<div className="col-sm-12 col-lg-4 left-side ">
						<img src={kiran} alt="kiran" className="img-thumbnail d-none  d-lg-block d-xl-block" />
						<div className="col-12 row contact">
							<h4 className="col-12">contact</h4>
							<p className="col-12">
								<FiPhoneCall className="mr-2" /> +918374242180
							</p>
							<p className="col-12">
								<IoIosMailOpen className="mr-2" /> saikiranchatlapalli84@gmail.com
							</p>
							<p className="col-12">
						...
						<div className="col-12 row follow">
							...
							<p className="col-12">
								<span>
									<a
										href="https://www.linkedin.com/in/sai-kiran-chatlapalli-6154b9201/"
										target="_blank"
										rel="noopener noreferrer"
										style={{ cursor: 'pointer', display: 'inline', color: 'black' }}
									>
										<FaLinkedin className="mr-2" />
										linkedin.com/in/sai-kiran-chatlapalli
									</a>
								</span>
							</p>
							...
							<p className="col-12">
								<span>
									<a
										href="https://github.com/CSaiKiran8"
										target="_blank"
										rel="noopener noreferrer"
										style={{ cursor: 'pointer', display: 'inline', color: 'black' }}
									>
										<DiGithub className="mr-2" />
										github.com/CSaiKiran8
									</a>
								</span>
							</p>
